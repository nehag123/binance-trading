...
class API
{
    ...
    /**
     * historicalTrades get Market History / historicalTrades Trades
     *
     * $trades = $api->historicalTrades("BNBBTC");
     *
     ...
     * @throws \Exception
     */
    public function historicalTrades(string $symbol)
    {
        return $this->historicalTrades($this->httpRequest("v1/historicalTrades", "GET", [
            "symbol" => $symbol,
        ]));
    }
